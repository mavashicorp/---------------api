...
// function getWeather(){
// fetch('http://api.openweathermap.org/data/2.5/weather?id=703494&lang=ru&appid=34747752906cc3846e5748a60c5d8956').then(function (resp) {return resp.json() }).then(function (data) {
